...
import Markets from "./dashboard/Miners";
      ...
      <div className="flex gap-6 p-6">
        ...
        <div className="bg-white dark:bg-[#1C1C25] flex flex-col gap-4 p-4 rounded-xl w-[325px]">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <h3 className="font-semibold text-base">Active Miners</h3>
              <p className="text-[#626D7D] text-[13px] font-medium">&uptime</p>
            </div>
          </div>
          ...
          <div className="flex justify-between items-center gap-2">
            ...
            <span className="text-green-700 text-xs font-bold">+$96.78</span>
            <span className="bg-[#21965333] text-[11px] font-semibold p-1.5 rounded-full text-[#219653]">
              +14.67%
            </span>
          </div>
        ...
        <div className="bg-white dark:bg-[#1C1C25] flex flex-col gap-4 p-4 rounded-xl w-[325px]">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <h3 className="font-semibold text-base">Current profit</h3>
              <p className="text-[#626D7D] text-[13px] font-medium">Last 24h</p>
            </div>
          </div>
          {/* card center */}
          <div className="flex justify-between items-end gap-4">
            <h1 className="font-semibold text-3xl">$98.24</h1>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="135"
              height="58"
        ...
        <div className="bg-white dark:bg-[#1C1C25] flex flex-col gap-4 p-4 rounded-xl w-[325px]">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <h3 className="font-semibold text-base">Registered users</h3>
              <p className="text-[#626D7D] text-[13px] font-medium"></p>
            </div>
          </div>
          {/* card center */}
          <div className="flex justify-between items-end gap-4">
            <h1 className="font-semibold text-3xl">142</h1>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="138"
              height="49"
